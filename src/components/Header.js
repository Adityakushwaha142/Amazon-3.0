  ...
  return (
    <header>
      ...
      <div className="flex items-center space-x-3 p-2 pl-6 bg-amazon_blue-light text-white text-sm">
        <p className="link cursor-pointer flex items-center">
          <MenuIcon className="h-6 mr-1" />
          All
        </p>
        <p className="cursor-pointer link ">Prime Video </p>
        <p className="cursor-pointer link ">Amazon Business </p>
        <p className="cursor-pointer link ">Today's Deals</p>
        <p className="cursor-pointer link hidden md:inline-flex  ">
          Electronics
        </p>
        <p className="cursor-pointer link hidden md:inline-flex  ">
          Food & Grocery
        </p>
        <p className="cursor-pointer link hidden md:inline-flex  ">Prime</p>
        <p className="cursor-pointer link hidden md:inline-flex  ">Buy Again</p>
        <p className="cursor-pointer link hidden md:inline-flex  ">
          Shopper Toolkit
        </p>
        <p className="cursor-pointer link hidden md:inline-flex  ">
